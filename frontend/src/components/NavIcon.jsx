const ICONS = {
  ...
  messages: (
    <>
      ...
      <path d="m21 3-7 18-4.5-6.5L3 10l18-7Z" />
    </>
  ),
  music: (
    <>
  ...
  notifications: (
    <>
      <path d="M20.8 4.6c-1.6-1.8-4.2-1.7-5.8.1L12 8l-3-3.3c-1.6-1.8-4.2-1.9-5.8-.1-1.7 1.9-1.5 4.8.4 6.5L12 19l8.4-7.9c1.9-1.7 2.1-4.6.4-6.5Z" />
    </>
  ),
  search: (
    <>
